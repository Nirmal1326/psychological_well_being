...
class RelaxationyogaVideoScreen extends StatefulWidget {
  @override
  _RelaxationyogaVideoScreenState createState() =>
      _RelaxationyogaVideoScreenState();
}

class _RelaxationyogaVideoScreenState extends State<RelaxationyogaVideoScreen> {
  late PageController _pageController;
  late List<VideoPlayerController> _controllers;

  final List<String> videoUrls = [
    'images/video/yoga0.mp4',
    'images/video/yoga1.mp4',
  ];
